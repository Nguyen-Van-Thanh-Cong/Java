...
public class HVDH extends HocVien {
...
public HVDH(String hoten, String diachi, String loaichuongtrinh, String loai, int sobuoi, int dongiadh) {
...
public void nhap() {
	...
	System.out.println("So buoi,Don gia DH:");
	sobuoi=sc.nextInt();
	dongiadh=sc.nextInt();
}public void in() {
	super.in();
