...
public class HVLT extends HocVien{
...
public HVLT(String hoten, String diachi, String loaichuongtrinh, String loai, int sobuoi, int dongialt) {
...
public void nhap() {
	...
	System.out.println("So buoi,Don gia LT:");
	sobuoi=sc.nextInt();
	dongialt=sc.nextInt();
}
public void in() {
